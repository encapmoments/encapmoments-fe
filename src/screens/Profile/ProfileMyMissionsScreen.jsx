    ...
    return (
        <>
            <SafeAreaView style={pmStyles.safeArea}>
                <View style={pmStyles.backgroundStyle} behavior="height" keyboardVerticalOffset={0} >
                    <TouchableOpacity onPress={() => navigation.pop()} style={pmStyles.touchBackArrow}>
                        <Image
                ...
                <View style={pmStyles.missionWrapper}>
                    ...
                    <View style={pmStyles.missionWrapperWrapper}>
                        <ScrollView showsHorizontalScrollIndicator={false} style={pmStyles.weeklyMissionWrapper}>
                    ...
                    <View style={pmStyles.missionWrapperWrapper}>
                        <ScrollView showsHorizontalScrollIndicator={false} style={pmStyles.dailyMissionWrapper}>
