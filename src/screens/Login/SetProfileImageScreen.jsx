      ...
      <View style={loginStyles.backgroundStyle}>
        <View style={{ padding: safePadding }}>
          <TouchableOpacity
            ...
            style={loginStyles.touchBackArrow}>
            <Image
          ...
          <View style={loginStyles.setProfileImageWrapper}>
            <TouchableOpacity onPress={handleImagePick}>
              {selectedImage ? (
                <>
                  <Image
                    style={loginStyles.setProfileImage}
                    source={{ uri: selectedImage }}
                    resizeMode="cover"
                  />
                  <View style={loginStyles.pencilIconWrapper}>
                    <Image
                      style={loginStyles.pencilIcon}
                ...
                <Image
                  style={loginStyles.plusIcon}
                  source={require("../../assets/icons/plusIcon.png")}
                />
              )}
            </TouchableOpacity>
          </View>
          <Text style={loginStyles.setProfileImageDescription}>
            프로필 이미지를 설정하세요!
          </Text>
          <CommonButton
            title="다음"
